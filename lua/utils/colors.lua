-- [nfnl] Compiled from fnl/utils/colors.fnl by https://github.com/Olical/nfnl, do not edit.
...
local function complementary(c)
  local _18_
  if (181 > c[1]) then
    _18_ = (180 + c[1])
  else
...
local function gradient_n(c1, c2, n)
  ...
  return vim.list_extend({c1}, vim.tbl_map(_21_, ls), {c2})
end
local function variations(color, f, n)
  local results = {}
  for i = 1, n do
    table.insert(results, f(color, i, n))
  end
  return results
end
