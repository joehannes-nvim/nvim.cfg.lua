...
local function _1_()
  return (require("marks")).setup({bookmark_0 = {sign = "\239\128\174", virt_text = " (\239\128\174 0) "}, bookmark_1 = {sign = "\239\128\174", virt_text = " (\239\128\174 1) "}, bookmark_2 = {sign = "\239\128\174", virt_text = " (\239\128\174 2) "}, bookmark_3 = {sign = "\239\128\174", virt_text = " (\239\128\174 3) "}, bookmark_4 = {sign = "\239\128\174", virt_text = " (\239\128\174 4) "}, bookmark_5 = {sign = "\239\128\174", virt_text = " (\239\128\174 5) "}, bookmark_6 = {sign = "\239\128\174", virt_text = " (\239\128\174 6) "}, bookmark_7 = {sign = "\239\128\174", virt_text = " (\239\128\174 7) "}, bookmark_8 = {sign = "\239\128\174", virt_text = " (\239\128\174 8) "}, bookmark_9 = {sign = "\239\128\174", virt_text = " (\239\128\174 9) "}, default_mappings = true, mappings = {annotate = "m@", m6 = false, m7 = false, m0 = false, m1 = false, m2 = false, m3 = false, m9 = false, m4 = false, m8 = false, m5 = false}})
end
local function _2_()
